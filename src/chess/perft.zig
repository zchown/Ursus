...
pub fn runShredderPerftTests() !void {
    const positions = [_]Chess960Position{
        ...
        .{ .fen = "r1kqbrnn/pp1pp1p1/7p/2P2p2/5b2/3P4/P1P1P1PP/RBKQBRNN w FAfa - 0 9", .depth = 6, .expected = 157499039, .note = "Shredder 904" },
        ...
        .{ .fen = "rbkqrnbn/pppp1p2/4p1p1/7p/7P/P2P4/BPP1PPP1/R1KQRNBN w EAea - 0 9", .depth = 6, .expected = 218658292, .note = "Shredder 908" },
        ...
        .{ .fen = "brkr1bqn/1pppppp1/3n3p/1p6/P7/4P1P1/1PPP1P1P/BRKRN1QN w DBdb - 0 9", .depth = 6, .expected = 81787718, .note = "Shredder 930" },
        ...
        .{ .fen = "rbkrnqb1/2ppppp1/p5np/1p6/8/3N4/PPPPPPPP/RBKRQNB1 w DAda - 2 9", .depth = 6, .expected = 133936564, .note = "Shredder 940" },
        ...
        .{ .fen = "brkr1nqb/pp1p1pp1/2pn3p/P3p3/4P3/6P1/1PPP1P1P/BRKRNNQB w DBdb - 0 9", .depth = 6, .expected = 103537333, .note = "Shredder 947" },
        ...
        .{ .fen = "r1krnnbq/pp1ppp1p/6p1/2p5/2P5/P3P3/Rb1P1PPP/1BKRNNBQ w Dda - 0 9", .depth = 6, .expected = 28753562, .note = "Shredder 956" },
        ...
        .{ .fen = "rkrnnqbb/p1ppp2p/Qp6/4Pp2/5p2/8/PPPP2PP/RKRNN1BB w CAca - 0 9", .depth = 6, .expected = 915268405, .note = "Shredder 959" },
