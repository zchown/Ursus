...
fn getKingZone(king_sq: usize, color: brd.Color, move_gen: *mvs.MoveGen) u64 {
    var zone: u64 = move_gen.king_attacks[king_sq] | (@as(u64, 1) << @intCast(king_sq));
